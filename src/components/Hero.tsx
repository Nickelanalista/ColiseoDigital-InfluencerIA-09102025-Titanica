        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-3 -right-3 bg-gradient-to-br from-orange-500 to-pink-600 text-white rounded-xl p-2 sm:p-3 shadow-2xl min-w-[135px] sm:min-w-[160px]">
                <div className="flex justify-end mb-1">
                  <div className="text-[10px] sm:text-xs font-semibold bg-white/30 rounded-md px-2 py-0.5 backdrop-blur-sm line-through flex items-baseline gap-1">
                    <span>Antes: 39</span>
                    <span className="text-[8px] sm:text-[9px]">USD</span>
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold leading-tight flex items-baseline justify-center gap-0.5 sm:gap-1">
                    <span>4.99</span>
                    <span className="text-xs sm:text-sm font-semibold">USD</span>
                  </div>
                  <div className="text-[9px] sm:text-[10px] mt-0.5 font-medium opacity-90">Precio Ahora</div>
                </div>
              </div>
