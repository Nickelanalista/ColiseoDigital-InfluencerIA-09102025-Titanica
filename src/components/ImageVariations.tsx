    ...
    <section className="py-12 md:py-20 lg:py-24 px-4 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-10 md:mb-16">
          <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full mb-4">
            <Sparkles className="w-3.5 h-3.5 md:w-4 md:h-4 text-blue-600" />
            <span className="text-xs md:text-sm font-semibold text-blue-600">PASO 5</span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 md:mb-4 tracking-tight px-4">
            Crea Videos con Productos
          </h2>
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4">
            Genera contenido en video mostrando productos en uso. Transforma fotos estáticas en demostraciones dinámicas que venden más.
          </p>
        </div>
