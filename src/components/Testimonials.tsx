...
const testimonials = [
  {
    quote: 'De 3 a 50+ variaciones por semana. Hemos multiplicado nuestro testing sin aumentar costos.',
    author: 'María González',
    company: 'Growth Manager, E-commerce Fashion',
    image: '/ugc/kate/modelo_casual_1.jpg',
    rating: 5,
  },
  {
    quote: 'Los prompts y workflows nos permitieron lanzar campañas en 2 días en lugar de 2 semanas.',
    author: 'Carlos Ruiz',
    company: 'Founder, Brand de Suplementos',
    image: '/ugc/dave/dave_deporte_2.jpg',
    rating: 5,
  },
  {
    quote: 'Creamos nuestro influencer de café en un fin de semana. El contenido se ve increíblemente real.',
    author: 'Ana Silva',
    company: 'Marketing Lead, Startup F&B',
    image: '/ugc/james/james_cafe.jpg',
    rating: 5,
  },
  {
    quote: 'La sección de video-to-video cambió completamente nuestro approach de contenido dinámico.',
    author: 'Diego Morales',
    company: 'Creative Director, Agencia Digital',
    image: '/ugc/kate/modelo_joga_3.jpg',
    rating: 5,
  },
];
